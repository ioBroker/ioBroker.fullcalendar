...
let __tla = (async () => {
  ...
  x = (e2) => {
    v = e2.ThemeProvider, y = e2.useTheme, b = e2.unstable_nested, _ = e2.default ?? e2;
  };
  f(s.share, {
    canonical: `default:@mui/private-theming`,
    aliases: [
      `@mui/private-theming`
    ]
  }, x);
  ...
  S === void 0 ? c(a.then(() => {
    ...
    return t(() => import("./_virtual_mf___mfe_internal__fullcalendar__mf_owner__219446345750563__prebuild___mf_0_mui_mf_1_private_mf_2_theming__prebuild__-B3F0s2nz.js").then(async (m2) => {
      await m2.__tla;
      return m2;
    }).then((e2) => {
      S = g(e2), h(s.share, {
