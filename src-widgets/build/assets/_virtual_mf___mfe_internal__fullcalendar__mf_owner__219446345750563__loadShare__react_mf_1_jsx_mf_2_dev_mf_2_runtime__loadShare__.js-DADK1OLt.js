...
let __tla = (async () => {
  ...
  var l = (e2, t2) => {
  ...
  }, u = Symbol.for(`module-federation.shared-cache-listeners`), d = (e2) => {
    let t2 = e2[u];
  ...
  }, p = Symbol.for(`module-federation.shared-cache-owners`), m = (e2) => {
    let t2 = e2[p];
    ...
    v = e2.Fragment, y = e2.jsxDEV, _ = e2.default ?? e2;
  };
  f(s.share, {
    canonical: `default:react/jsx-dev-runtime`,
    aliases: [
  ...
  x === void 0 ? c(a.then(() => {
    ...
    return t(() => import("./_virtual_mf___mfe_internal__fullcalendar__mf_owner__219446345750563__prebuild__react_mf_1_jsx_mf_2_dev_mf_2_runtime__prebuild__-BEQ_MXdj.js").then(async (m2) => {
      await m2.__tla;
      return m2;
    }).then((e2) => {
      x = g(e2), h(s.share, {
