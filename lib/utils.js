...
function getAstroTime(astro, offset, date, _SunCalc, _systemConfig, _adapterConfig) {
    ...
    if (_systemConfig.common.latitude  === undefined ||
    ...
    const times = (_SunCalc || SunCalc).getTimes(_date,
        _adapterConfig.native.latitude || _systemConfig.common.latitude,
        _adapterConfig.native.longitude || _systemConfig.common.longitude);
    _date = times[astro];
    if (offset) {
