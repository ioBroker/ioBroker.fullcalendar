            ...
            <Chip
                ...
                deleteIcon={
                    exceptions.includes(id) ? (
                        <Add title={I18n.t('Include to list again')} />
                    ) : (
                        <Remove title={I18n.t('Exclude from list')} />
                    )
                }
                style={{
                    ...styles.chip,
            ...
            return (
                ...
                >
                    <div style={{ display: 'flex' }}>
                        <Checkbox
                            checked={selectedEnums.includes(tree.object._id)}
                            size="small"
                        />
                        <TextWithIcon
                            value={tree.object}
                    ...
                    <Paper style={styles.content}>
                        {enumsTree.items?.enum &&
                            Object.keys(enumsTree.items.enum.items).map(id =>
                                renderEnums(enumsTree.items.enum.items[id], id),
                            )}
                    </Paper>
            ...
            <DialogActions>
                <Button
                    disabled={
                        ...
                        (JSON.stringify(selectedEnums.sort()) === JSON.stringify(props.selectedEnums.sort()) &&
                            JSON.stringify(exceptions.sort()) === JSON.stringify(props.exceptions.sort()))
                    }
                    onClick={() => {
