...
let __tla = (async () => {
  ...
  var l = (e2, t2) => {
    ...
    v = e2.createRoot, y = e2.hydrateRoot, b = e2.version, _ = e2.default ?? e2;
  };
  f(s.share, {
  ...
  S === void 0 ? c(a.then(() => {
    ...
    return t(() => import("./_virtual_mf___mfe_internal__fullcalendar__mf_owner__219446345750563__prebuild__react_mf_2_dom_mf_1_client__prebuild__-BFeYclNy.js").then(async (m2) => {
      await m2.__tla;
      return m2;
    }).then((e2) => {
      S = g(e2), h(s.share, {
