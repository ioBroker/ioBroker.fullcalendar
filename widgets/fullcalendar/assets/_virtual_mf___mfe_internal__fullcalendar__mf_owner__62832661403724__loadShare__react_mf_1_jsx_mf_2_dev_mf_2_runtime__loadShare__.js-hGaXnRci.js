...
let __tla = (async () => {
  ...
  var u = (e2, t2) => {
    ...
    y = e2.Fragment, b = e2.jsxDEV, v = e2.default ?? e2;
  };
  p(c.share, {
  ...
  S === void 0 ? l(o.then(() => {
    ...
    return n(() => import("./_virtual_mf___mfe_internal__fullcalendar__mf_owner__62832661403724__prebuild__react_mf_1_jsx_mf_2_dev_mf_2_runtime__prebuild__-A5A_f5qa.js").then(async (m2) => {
      await m2.__tla;
      return m2;
    }).then((e2) => {
      S = _(e2), g(c.share, {
