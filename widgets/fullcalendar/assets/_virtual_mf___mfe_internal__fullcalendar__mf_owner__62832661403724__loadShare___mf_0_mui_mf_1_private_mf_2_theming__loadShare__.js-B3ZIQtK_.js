...
let __tla = (async () => {
  ...
  S = (e2) => {
    y = e2.ThemeProvider, b = e2.useTheme, x = e2.unstable_nested, v = e2.default ?? e2;
  };
  p(c.share, {
  ...
  C === void 0 ? l(o.then(() => {
    ...
    return n(() => import("./_virtual_mf___mfe_internal__fullcalendar__mf_owner__62832661403724__prebuild___mf_0_mui_mf_1_private_mf_2_theming__prebuild__-DKHjmsBJ.js").then(async (m2) => {
      await m2.__tla;
      return m2;
    }).then((e2) => {
      C = _(e2), g(c.share, {
